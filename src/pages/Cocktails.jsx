...
const cocktails = [
  { name: 'The Limberlost', ingredients: 'Illinois bourbon, raw honey, lemon, thyme smoke', desc: 'Our namesake cocktail. A smoky, herbaceous old fashioned variation finished with a cloche of smoldering thyme from the garden.' },
    ...
    <>
        ...
        <div className="container">
          <div className="intro__grid">
            <Reveal>
              ...
              <p>The Hearth is Limberlost's cocktail bar — a low-lit gathering place built around a massive stone fireplace. Our bar program draws on the same philosophy as our kitchen: seasonal, local, and crafted with intention.</p>
              <p>Illinois-distilled spirits form the backbone of our menu, enhanced with house-made syrups, garden-grown herbs, and foraged botanicals. Whether you settle into a leather chair by the fire or take your drink to the outdoor terrace, The Hearth is where evenings at Limberlost begin and end.</p>
            </Reveal>
      ...
      <section className="section section--dark">
        <div className="container">
          ...
          <p className="menu__intro">Our cocktail menu rotates with the seasons. These signatures capture the spirit of Limberlost.</p>
